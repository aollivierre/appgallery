    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        function CreateDetectionFile {
            ...
            if (-not (Test-Path -Path (Split-Path $filePath))) {
                ...
                Write-EnhancedLog -Message "created Detection Directory $filePath" -Level "INFO" -ForegroundColor ([ConsoleColor]::Green)
            }
        ...
        CreateDetectionFile
        Write-EnhancedLog -Message "created Detection file C:\Intune\Win32\RemoveWSUS\detect$file_extension " -Level "INFO" -ForegroundColor ([ConsoleColor]::Green)

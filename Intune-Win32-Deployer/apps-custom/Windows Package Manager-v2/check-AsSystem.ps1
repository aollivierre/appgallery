#Unique Tracking ID: 7d5a28fa-5c72-446b-b40d-bcaf56af36b5, Timestamp: 2024-04-03 09:44:46
# JSON string
$json = @'
{
    "PackageName": "APP008-WingetPackageManager",
    "PackageUniqueGUID": "7b34084e-b856-40f5-9a5b-32b3249fb777",
    "Version": 1,
    "PackageExecutionContext": "SYSTEM",
    "RepetitionInterval": "PT60M",
    "LoggingDeploymentName": "APP008-WingetPackageManagerCustomlog",

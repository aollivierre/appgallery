...
$CustomWin32AppName = "PR4B-RemoveWSUS-v8"
...
function Upload-Win32App ($Prg, $Prg_Path, $Prg_img) {
    ...
    try {
        ...
        $IntuneAppParams = @{
            ...
            # DisplayName               = "PR4B-RemoveWSUS-v8"
            # Description               = $Prg.description
            Description               = "Automates the detection and remediation of issues related to WSUS (Windows Server Update Services) configurations."
            Publisher                 = $global:SettingsVAR.Publisher
            AppVersion                = "8.0.0"  # Placeholder value
            Developer                 = "Abdullah Ollivierre"  # Placeholder value
            Owner                     = "Abdullah Ollivierre"  # Placeholder value
            Notes                     = "Unique Tracking ID 164b62a0-6e1b-4463-aab8-14e187925233"  # Placeholder value

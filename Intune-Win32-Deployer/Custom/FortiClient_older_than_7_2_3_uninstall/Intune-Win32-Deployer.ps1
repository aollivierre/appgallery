...
$CustomWin32AppName = "FortiClient-EMS-V6"
...
function Upload-Win32App ($Prg, $Prg_Path, $Prg_img) {
    ...
    try {
        ...
        $IntuneAppParams = @{
            ...
            # DisplayName               = "PR4B-BitLockerRecoveryEscrow"
            # Description               = $Prg.description
            Description               = "FortiClient Products older than 7.2.3 or not FortiClient VPN v7.2.3"
            Publisher                 = $global:SettingsVAR.Publisher
            AppVersion                = "older than 7.2.3"  # Placeholder value
            Developer                 = "Abdullah Ollivierre"  # Placeholder value
            Owner                     = "Abdullah Ollivierre"  # Placeholder value
            Notes                     = "Unique Tracking ID a3cc17e6-ae66-4c50-9778-9b196cecdf99"  # Placeholder value

...
$CustomWin32AppName = "PR4B-BitLockerRecoveryEscrow"
...
function Upload-Win32App ($Prg, $Prg_Path, $Prg_img) {
    ...
    try {
        ...
        $IntuneAppParams = @{
            ...
            Description               = "Automates the detection and remediation of issues related to BitLocker Recovery Key Escrow"
            ...
            Notes                     = "Unique Tracking ID fdab294a-21cd-473a-b5cd-5ba2e9abc85c"  # Placeholder value

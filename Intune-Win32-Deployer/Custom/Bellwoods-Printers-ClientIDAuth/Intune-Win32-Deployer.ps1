...
$CustomWin32AppName = "PRINT:003 - MX-3071 - SHARP - Concorde - CRM - 192.168.53.155 - Cert - PSADT"
...
function Upload-Win32App ($Prg, $Prg_Path, $Prg_img) {
    ...
    try {
        ...
        $IntuneAppParams = @{
            ...
            Notes                    = "#Unique Tracking ID 5cf3fcd8-49a8-4733-8726-94876ba7130e"  # Placeholder value

...
$CustomWin32AppName = "PR4B:001 - Adobe - Set - Default - PDF"
...
function Upload-Win32App ($Prg, $Prg_Path, $Prg_img) {
    ...
    try {
        ...
        # $connectionParams = @{
        #     clientId = "xxxxxxxxxxxxxxx-4eb1d0b50e92"
        #     tenantID = "xxxxxxxxxxxxxxxxx-c15d21a89f13"
        #     ClientSecret = "xxxxxxxxxxxxxxx"  # Replace with your actual Client Secret
        # }
        ...
        $IntuneAppParams = @{
            ...
            Notes                    = "#Unique Tracking ID b8f78ea7-6dfc-4986-b0d9-f007cfc16ce4"  # Placeholder value

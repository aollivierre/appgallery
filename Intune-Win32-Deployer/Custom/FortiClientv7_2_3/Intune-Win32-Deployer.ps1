...
$CustomWin32AppName = "FortiClient-VPN-7.2.3"
...
function Upload-Win32App ($Prg, $Prg_Path, $Prg_img) {
    ...
    try {
        ...
        $IntuneAppParams = @{
            ...
            Description               = "FortiClient VPN Client V7.2.3"
            Publisher                 = $global:SettingsVAR.Publisher
            AppVersion                = "7.2.3"  # Placeholder value
            Developer                 = "Abdullah Ollivierre"  # Placeholder value
            Owner                     = "Abdullah Ollivierre"  # Placeholder value
            Notes                     = "Unique Tracking ID a39a34be-6c0e-47ac-962c-4a8fc44b1c77"  # Placeholder value

...
# & $officeC2RClientPath /changesetting Channel=$channel displaylevel=false forceappshutdown=false
...
# & $officeC2RClientPath /update user displaylevel=false forceappshutdown=false

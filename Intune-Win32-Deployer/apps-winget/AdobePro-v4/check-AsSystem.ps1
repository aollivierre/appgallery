#Unique Tracking ID: 8cc249ec-1e46-452b-bf9a-6f94a6d73493, Timestamp: 2024-04-04 18:30:45
# JSON string
$json = @'
{
    "PackageName": "APP006-AdobeReaderPro",
    "PackageUniqueGUID": "7b34084e-b856-40f5-9a5b-32b3249fb777",
    "Version": 1,
    "PackageExecutionContext": "SYSTEM",
    "RepetitionInterval": "PT60M",
    "LoggingDeploymentName": "APP006-AdobeReaderProCustomlog",

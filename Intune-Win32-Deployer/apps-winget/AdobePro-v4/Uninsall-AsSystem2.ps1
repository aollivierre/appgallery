#Unique Tracking ID: e4c71dea-f54f-4bbb-8856-2cb43d2565ed, Timestamp: 2024-04-04 18:30:45
...
function Uninstall-AdobeReaderProApplication {
    [CmdletBinding()]
    param()
    ...
    process {
        try {
            $uninstallString = Find-UninstallString -UninstallKeys $uninstallKeys -ApplicationName "*AdobeReaderPro*"
            ...
            if ($null -ne $uninstallString) {
                ...
                # $uninstallStringPostExeUninstall = Find-UninstallString -UninstallKeys $uninstallKeys -ApplicationName "*AdobeReaderPro*"
                ...
                Write-Host "Uninstall string not found for AdobeReaderPro application."
            }
        } catch {
...
Uninstall-AdobeReaderProApplication

...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        If (-not $useDefaultMsi) {
            Show-InstallationPrompt -Message 'You should now see the latest Microsoft 365 apps (Word, Excel, PowerPoint, Outlook, etc..) in your start menu' -ButtonRightText 'OK' -Icon Information -NoWait
        }
    }

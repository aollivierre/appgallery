...
foreach ($ModuleName in $ModuleNames) {
    ...
    if ($ModuleFilePath) {
        Write-EnhancedLog -Message "Importing module: $ModuleName" -Level "INFO" -ForegroundColor ([ConsoleColor]::Cyan)
        Import-Module -Name $ModuleFilePath
        Write-EnhancedLog -Message "Module: $ModuleName has been Imported" -Level "INFO" -ForegroundColor ([ConsoleColor]::Cyan)
    } else {
        Write-EnhancedLog -Message "Module not found: $ModuleName" -Level "ERROR" -ForegroundColor ([ConsoleColor]::Red)
    }
}
...
$azurePassword = ConvertTo-SecureString "xxxxxxxxxxxxxxxx" -AsPlainText -Force

#Unique Tracking ID: 4543d4d6-3ecf-42c4-80f4-243f956d5d13, Timestamp: 2024-03-28 14:41:16
...
# Start-Process -FilePath "$PSScriptroot\Deploy-Application.exe" -ArgumentList "-DeploymentType `"Uninstall`"" -Wait -WindowStyle Hidden

Start-Process -FilePath "$PSScriptRoot\Deploy-Application.exe" -ArgumentList "-DeploymentType `"Uninstall`" -DeployMode `"Silent`"" -Wait -WindowStyle Hidden

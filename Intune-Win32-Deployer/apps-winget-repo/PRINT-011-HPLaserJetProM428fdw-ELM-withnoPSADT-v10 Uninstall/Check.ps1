#Unique Tracking ID: 301bc899-f89d-41b8-b62c-7786d30096b6, Timestamp: 2024-03-20 11:21:56


$json = @'
{
    "PrinterName": "HPED1D4B (HP LaserJet Pro M428f-M429f)",
    "PrinterIPAddress": "192.168.2.76",
    "PortName": "IP_192.168.2.76",

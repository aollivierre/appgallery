#Unique Tracking ID: f126bcef-c006-4940-aed1-b1ea68124f50, Timestamp: 2024-03-28 12:12:52
# JSON string
$json = @'
{
    "PackageName": "APP005-7zip",
    "PackageUniqueGUID": "7b34084e-b856-40f5-9a5b-32b3249fb777",
    "Version": 1,
    "PackageExecutionContext": "SYSTEM",
    "RepetitionInterval": "PT60M",
    "LoggingDeploymentName": "APP005-7zipCustomlog",

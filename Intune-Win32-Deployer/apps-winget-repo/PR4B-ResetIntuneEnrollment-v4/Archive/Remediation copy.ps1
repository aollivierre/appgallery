...
#             Write-EnhancedLog -Message "Removing Intune certificate $($_.DnsNameList.Unicode)" -Level Info
...
#             Write-EnhancedLog -Message "Folder Name: $($folder.Name)" -Level Info
#             Write-EnhancedLog -Message "Folder Path: $($folder.Path)" -Level Info
...
#                 Write-EnhancedLog -Message "Removing task scheduler Enterprise Management entries for GUID - $([string]$EnrollmentGUID)" -Level Info
...
#                     Write-EnhancedLog -Message "Task removed successfully from path: $taskPath2" -Level Success
#                 }
#                 catch {
...
#                     Write-EnhancedLog -Message "Parent task folder for GUID - $([string]$EnrollmentGUID) removed successfully" -Level Success
#                 }
#                 catch {
#                     Write-Host "Error: $($_.Exception.Message)" -ForegroundColor Red
#                 }
...
#                         Write-EnhancedLog -Message "GUID entry found in $Key. Removing..." -Level Information
...
#                         Write-EnhancedLog -Message "Error: unable to obtain enrollment GUID $EnrollmentGUID value from $key" -Level Error
...
#     Write-EnhancedLog -Message "Checking for MDM certificate in computer certificate store" -Level "Info"
#     Get-ChildItem 'Cert:\LocalMachine\My\' | Where-Object Issuer -EQ "CN=Microsoft Intune MDM Device CA" | ForEach-Object {
#         Write-EnhancedLog -Message "Removing Intune certificate $($_.DnsNameList.Unicode)" -Level "Info"
#         Remove-Item $_.PSPath
#     }
...
#     Write-EnhancedLog -Message "Removing task scheduler Enterprise Management entries for GUID - $EnrollmentGUID" -Level "Info"
#     Get-ScheduledTask | Where-Object { $_.TaskPath -match $EnrollmentGUID } | Unregister-ScheduledTask -Confirm:$false
...
function Perform-IntuneCleanup {
    ...
    # Define the parameters in a hashtable for splatting
    # $certparams = @{
    #     CertStorePath = 'Cert:\LocalMachine\My\'
    #     IssuerName    = "CN=Microsoft Intune MDM Device CA"
    #     Timeout       = 30

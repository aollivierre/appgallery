#Unique Tracking ID: b4bfbd17-e8cb-4ba2-b5e7-93a47f596884, Timestamp: 2024-03-18 16:00:30
<#
.SYNOPSIS
...
# $AllScriptPaths = $initializationInfo.AllScriptPaths
# if ($null -ne $AllScriptPaths -and $AllScriptPaths.Count -gt 0) {
#     foreach ($SinglePath in $AllScriptPaths) {
#         try {
#             . $SinglePath
#             Write-EnhancedLog -Message "Dot-sourcing script: $(Split-Path -Leaf $SinglePath)" -Level INFO -ForegroundColor Cyan
#         }
#         catch {
#             Write-EnhancedLog -Message "Error dot-sourcing script: $_" -Level ERROR -ForegroundColor Red
#         }
#     }
#     Write-Host "Initialization and dot-sourcing of script files completed successfully." -ForegroundColor Green
# }
# else {
#     Write-Host "No scripts were found to dot-source." -ForegroundColor Yellow
# }


# Using the .psd1 file if you have a module manifest
# Import-Module 'C:\Code\CB\Modules\EnhancedLoggingAO\EnhancedLoggingAO.psd1'

# Install-Module -Name "EnhancedLoggingAO" -Scope AllUsers
# Import-Module -Name "EnhancedLoggingAO"
# Import-Module -Name "EnhancedLoggingAO"

# OR, if you're directly importing the .psm1 file
# Import-Module 'C:\Users\aollivierre\AppData\Local\Intune-Win32-Deployer\apps-winget\PR4B-ResetIntuneEnrollment-v6\Private\EnhancedLoggingAO\1.0.0\EnhancedLoggingAO.psm1'


# Assuming this script is located in "C:\Users\aollivierre\AppData\Local\Intune-Win32-Deployer\apps-winget\PR4B-ResetIntuneEnrollment-v6"

# Build the path to the module dynamically
$modulePath = Join-Path -Path $PSScriptRoot -ChildPath "Private\EnhancedLoggingAO\1.0.0\EnhancedLoggingAO.psm1"

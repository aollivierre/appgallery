...
#Example Usage
# WinGet-Wrapper -PackageName 7zip.7zip -ArgumentList "install --exact --id 7zip.7zip --silent --accept-package-agreements --accept-source-agreements --scope Machine"
#Unique Tracking ID: f4b53c2d-f219-42d4-aa69-de10cab057ab, Timestamp: 2024-03-20 11:16:41


$json = @'
{
    "PrinterName": "HP Laserjet Pro M1212nf - Deauville - New",
    "PrinterIPAddress": "192.168.2.18",
    "PortName": "IP_192.168.2.18",
